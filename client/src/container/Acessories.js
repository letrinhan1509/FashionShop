...
const Accessories = (props) => {
  ...
  const background = {
    backgroundImage: `url("https://canifa.s3.amazonaws.com/media/wysiwyg/ao-so-mi-nam-listing.jpg")`,
  };
  return (
    <>
      ...
      <div>
        <Carousel autoplay>
          <div style={background}>
            <img height="600px" width="100%" src="./images/slider/slider_pk1.jpg" />
          </div>
          <div>
            <img height="600px" width="100%" src="./images/slider/slider_pk2.jpg" />
          </div>
          <div>
            <img height="600px" width="100%" src="./images/slider/slider_pk3.jpg" />
          </div>
        </Carousel>
      </div>
      <p style={{ textAlign: "center", fontSize: "26px", fontWeight: "bold" }}>
        Tổng số lượng sản phẩm : {props.countPhukien}
      </p>
      <Row>
        <Col span={22} offset={1}>
          <div className="site-card-wrapper product_home">
            <Row gutter={16} justify="space-around">
              {props.Phukien.slice(0, visible).map((productItem) => {
                return (
