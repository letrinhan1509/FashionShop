  ...
  return (
    <>
      ...
      <div>
        <Carousel autoplay>
          <div>
            <img height="600px" width="100%" src="./images/slider/slider_balo1.jpg" />
          </div>
          <div>
            <img height="600px" width="100%" src="./images/slider/slider_balo2.jpg" />
          </div>
          <div>
            <img height="600px" width="100%" src="./images/slider/slider_balo3.jpg" />
          </div>
        </Carousel>
      </div>
        ...
        <Col span={22} offset={1}>
          <div className="site-card-wrapper product_home">
            <Row gutter={16} justify="space-around">
              {props.Balo.slice(0, visible).map((productItem) => {
                return (
