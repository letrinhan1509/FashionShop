  ...
  return (
    <>
      ...
      <div>
        <Carousel autoplay>
          <div>
            <img width="100%" src="./images/slider/slider_somi.jpg" />
          </div>
          <div>
            <img width="100%" src="./images/slider/slider_aokhoac.png" />
          </div>
          <div>
            <img width="100%" src="./images/slider/slider_aothun.jpg" />
          </div>
        </Carousel>
      </div>
      <p style={{ textAlign: "center", fontSize: "26px", fontWeight: "bold" }}>
        Tổng số lượng sản phẩm : {props.countAo}
      </p>
      <Row>
